    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        if (mappedData.length === 0) {
          alert(
            "Format Excel salah atau kosong. Pastikan ada kolom soal dan jawaban.",
          );
          setImporting(false);
          return;
        }
        ...
        <form onSubmit={handleImportSubmit} className="space-y-4">
          <div className="bg-blue-50 text-blue-800 p-4 rounded-lg text-sm mb-4">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Baris pertama harus berisi header: <strong>Soal</strong>,{" "}
                <strong>Opsi A</strong> s/d <strong>Opsi E</strong>,{" "}
                <strong>Jawaban</strong>, dan <strong>Bobot</strong>.
              </li>
              <li>
                Pilih Guru, Mapel, dan Kelas yang akan menjadi pemilik dari
                soal-soal ini.
              </li>
            </ul>
          </div>
          ...
          <Select
            ...
            onChange={(e) =>
              setImportParams({ ...importParams, id_guru: e.target.value })
            }
            options={guruOptions}
            required
            disabled={importing}
          ...
          <Select
            ...
            onChange={(e) =>
              setImportParams({ ...importParams, id_mapel: e.target.value })
            }
          ...
          <Select
            ...
            onChange={(e) =>
              setImportParams({ ...importParams, id_kelas: e.target.value })
            }
